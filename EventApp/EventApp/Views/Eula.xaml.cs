...
This Holidaily End User License Agreement (the 'Agreement') is made between DVNT applications ('DVNT', 'Company', 'we', 'us', 'our') and you, our customer ('you', 'your') only. This Agreement governs your use of Holidaily and our online social media services ('Services').
...
2. Scope of License: DVNT Applications grants you a revocable, non­exclusive, non­transferable, limited license to download, install and use the Application solely for your personal, non­commercial purposes strictly in accordance with the terms of this Agreement. 
...
4. Modifications to Application: DVNT Applications reserves the right to modify, suspend or discontinue, temporarily or permanently, the Application or any service to which it connects, with or without notice and without liability to you.

5. Term and Termination: This Agreement shall remain in effect until terminated by you or ​DVNT Applications. DVNT Applications may, in its sole discretion, at any time and for any or no reason, suspend or terminate this Agreement with or without prior notice. This Agreement will terminate immediately, without prior notice from ​DVNT Applications​, in the event that you fail to comply with any provision of this Agreement. You may also terminate this Agreement by deleting the Application and all copies thereof from your mobile device or from your desktop. Upon termination of this Agreement, you shall cease all use of the Application and delete all copies of the Application from your mobile device or from your desktop. 
